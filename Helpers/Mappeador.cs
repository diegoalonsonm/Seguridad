...
namespace Helpers
{
    ...
    {
        public static TModeloSalida MapearObjetos<TModeloEntrada, TModeloSalida>(TModeloEntrada objOrigen, 
            Action<TModeloEntrada, TModeloSalida> ReglaTransformacion = null) where TModeloEntrada : class where TModeloSalida : new()
        {
            ...
            if ((object)objOrigen != null)
            {
                ...
                Mappeador.SincronizarObjetos<TModeloEntrada, TModeloSalida>(objOrigen, destino, properties1, properties2);
        ...
        private static void SincronizarObjetos<TModeloEntrada, TModeloSalida>(TModeloEntrada origen, TModeloSalida destino, PropertyInfo[] propiedadesOrigen,
